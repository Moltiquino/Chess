class White_king extends chessPawns{ 
            String chessPawn(){ return "WHITE_KING";}
              ...
              //check attack by Pawns
                if((srcRow>0)&&(srcRow<7)){
                    if((srcCol>0)&&(srcCol<7)){
                        ...
                        //check left cells 
                         if(chessboard[srcRow][srcCol-1].pawnType() !='W'){
                            if(chessboard[srcRow][srcCol-1].chessPawn().equals("BLACK_KING")){return true;}
                            for(int i=srcCol-1;i>=0; i--){
                                char c = chessboard[srcRow][i].pawnType();
                                switch(c){
                                    case 'W':break;
                                    case 'B':
                                        if((chessboard[srcRow][i].chessPawn().equals("BLACK_QUEEN"))||(chessboard[srcRow][i].chessPawn().equals("BLACK_ROOK"))){
                                            return true;
                                        }
                                        break;                                 
                                }
                         ...
                         if(chessboard[srcRow+1][srcCol-1].pawnType() !='W'){
                            if(chessboard[srcRow+1][srcCol-1].chessPawn().equals("BLACK_PAWN")||chessboard[srcRow+1][srcCol-1].chessPawn().equals("BLACK_KING"))
                            {return true;}
                            int i=1;
                            do{
                                ...
                                switch(c){
                                    case 'W':break;
                                    case 'B':{
                                            if((chessboard[srcRow+i][srcCol-i].chessPawn().equals("BLACK_QUEEN"))||
                                            (chessboard[srcRow+i][srcCol-i].chessPawn().equals("BLACK_BISHOP"))){
                                                return true;
                                        }
                                        break;}                           
                                    }
                         ...
                         //check bottom cells 
                         if(chessboard[srcRow+1][srcCol].pawnType() !='W'){
                             if(chessboard[srcRow+1][srcCol].chessPawn().equals("BLACK_KING")){return true;}
                            for(int i=srcRow+1;i<=7; i++){
                                char c = chessboard[i][srcCol].pawnType();
                                switch(c){
                                    case 'W':break;
                                    case 'B':
                                        if((chessboard[i][srcCol].chessPawn().equals("BLACK_QUEEN"))||(chessboard[i][srcCol].chessPawn().equals("BLACK_ROOK"))){
                                            return true;
                                        }
                                        break;                                 
                                }
                    ...
                    //check right cells  
                        if(chessboard[srcRow][srcCol+1].pawnType() !='W'){
                          ...
                          if(chessboard[srcRow+1][srcCol].pawnType() !='W'){
                            ...
                            //check bottom right cells  
                            if(chessboard[srcRow+1][srcCol+1].pawnType() !='W'){
                              if(chessboard[srcRow+1][srcCol+1].chessPawn().equals("BLACK_PAWN")||chessboard[srcRow+1][srcCol+1].chessPawn().equals("BLACK_KING")){return true;}
        ...
        //check right cells 
            ...
            if((srcRow+2 <= 7)&&(srcCol+1 <= 7)){
                if(chessboard[srcRow+2][srcCol+1].chessPawn().equals("BLACK_KNIGHT")){return true;}
            }
            ...
            if((srcRow+1 <= 7)&&(srcCol+2 <= 7)){
                if(chessboard[srcRow+1][srcCol+2].chessPawn().equals("BLACK_KNIGHT")){return true;}
            }  
